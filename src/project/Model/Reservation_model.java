...
public class Reservation_model {
		...
		if(chk == 2) {
			...
			for(int i = 0; i < possibleTime.size(); i++) {
				if(currentTime.compareTo(possibleTime.get(i).substring(0,5)) >= 0) {
					possibleTime.remove(possibleTime.get(i));
				}
			}
		}
	...
	public Reservation_DTO getReservation_DTO(String id, String name, String deptname, String docname, String symptom, String date, String time) {
